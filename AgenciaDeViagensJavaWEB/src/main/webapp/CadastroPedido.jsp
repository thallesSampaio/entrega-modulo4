  ...
  <div class="container-fluid">
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-6">
				<h1 class="mt-5" >Cadastro de Pedido</h1>
				<form class="mt-5" action="CadastrarPedido">
					<div class="form-group">
						<label for="nome">ID Cliente:</label> <input type="text"
							class="form-control" id="idCli" name="idCli" required>
					</div>
					<div class="form-group">
						<label for="nome">ID Destino:</label> <input type="text"
							class="form-control" id="idCli" name="idDest" required>
					</div>
					<div class="form-group">
						<label for="cpf">Data Viagem:</label> <input type="date"
							class="form-control" id="dataViagem" name="dataViagem" required>
					</div>
