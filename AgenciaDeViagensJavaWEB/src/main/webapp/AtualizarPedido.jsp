	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-6">
				...
				<form class="mt-5" action="EditarPedido">
				<div class="form-group">
						<label for="nome">ID Pedido:</label> <input type="text"
							class="form-control" id="idPed" name="idPed" readonly value="<%out.print(request.getAttribute("idPed"));%>">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="cpf">ID Destino:</label> <input type="text"
							class="form-control" id="idDest" name="idDest" readonly value="<%out.print(request.getAttribute("idDest"));%>">
					</div>
					<div class="form-group">
						<label for="cpf">Nova Data de Viagem:</label> <input type="text"
							class="form-control" id="dataViagem" name="dataViagem" required value="<%out.print(request.getAttribute("dataViagem"));%>">
					</div>
