...
<%
ArrayList<Destinos> lista = (ArrayList<Destinos>) request.getAttribute("destinos");
%>
<!DOCTYPE html>
<html>
<head>
			...
			<div class="row">
				<div class="col-md">
					<div class="card bg-transparent shadow">
						...
						<div class="card-body">
							<h1 class="title text-dark">Destinos</h1>
							<div class="tableContainer">
								...
								<tbody class="text-dark">
									<%
									for (Destinos dest : lista) {
									%>
									<tr>
										<td><%=dest.getDestino_id()%></td>
										<td><%=dest.getPais()%></td>
										<td><%=dest.getCidade()%></td>
										<td> <a href='SelecionarDestino?idDest=<%=dest.getDestino_id()%>' class='btn btn-outline-primary'><i class="bi bi-pencil-square"></i></a>
										     <a href='DeletarDestino?idDest=<%=dest.getDestino_id()%>' class='btn btn-outline-danger'><i class="bi bi-trash-fill"></i></a> 
										</td>
									</tr>
									<%
									}
