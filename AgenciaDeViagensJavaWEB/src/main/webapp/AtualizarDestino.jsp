  ...
  <div class="container-fluid">
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-6">
				<h1 class="mt-5" >Editar Destinos</h1>
				<form class="mt-5" action="EditarDestino">
				<div class="form-group">
						<label for="nome">ID Destino:</label> <input type="text"
							class="form-control" id="idDest" name="idDest" readonly value="<%out.print(request.getAttribute("idDest"));%>">
					</div>
					<div class="form-group">
						<label for="nome">Pais:</label> <input type="text"
							class="form-control" id="pais" name="pais" required value="<%out.print(request.getAttribute("pais"));%>">
					</div>
					<div class="form-group">
						<label for="cpf">Cidade:</label> <input type="text"
							class="form-control" id="cidade" name="cidade" required value="<%out.print(request.getAttribute("cidade"));%>">
					</div>
